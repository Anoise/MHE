...
from group_head import ArcFaceMHS, ArcFaceMHS_B1, ArcFaceMHS_V2
...
def main(args):
    ...
    # CircleLoss(cfg) #ArcFaceV3(cfg)  # ArcFaceV3(cfg) #MagFace(cfg)
    module_partial_fc = ArcFaceMHS_B1(cfg) #ArcFaceMHS_V2(cfg) #ArcFaceMHS(cfg)
    ...
    for epoch in range(start_epoch, cfg.num_epoch):
        ...
        callback_verification(global_step, backbone) ### epoch end to verification ...
