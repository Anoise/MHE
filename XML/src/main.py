...
if __name__ == '__main__':
    ...
    LOG = Logger('log_'+get_exp_name(args.dataset,args.bert,args.num_group))
    ...
    if args.eval_model and args.dataset in ['wiki500k', 'amazon670k','amazon13m']:
        ...
        model.load_state_dict(torch.load(f'models/model-{get_exp_name()}.bin',map_location='cpu'))
        model = model.cuda()
