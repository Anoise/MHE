...
elif [ "$1" = "amazon13m" ]; then
    echo start $1
    for str in ${arr[@]};do
        python src/main.py --lr 1e-4 --epoch 5 --dataset amazon13m --swa --swa_warmup 0 --swa_step 10000  --batch 16 --max_len 128 --eval_step 40000  --group_y_candidate_num 2000 --group_y_candidate_topk 30 --hidden_dim 400  --bert $str  --num_group 8761

        python src/main.py --lr 1e-4 --epoch 5 --dataset amazon13m --swa --swa_warmup 0 --swa_step 10000  --batch 16 --max_len 128 --eval_step 40000  --group_y_candidate_num 2000 --group_y_candidate_topk 30 --hidden_dim 400  --bert $str  --num_group 8761 --eval_model
    done
    python src/ensemble_direct.py --model1 amazon13m_t0 --model2 amazon13m_t1 --model3 amazon13m_t2 --dataset amazon13m
